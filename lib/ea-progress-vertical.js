(function($) {
  var EAProgressVertical, animateBottle, root, setProgressUI;
  root = this;
  animateBottle = function(direction, limit) {
    if (direction == null) {
      direction = 'fill';
    }
    if (limit == null) {
    ...
    if ((direction === 'fill' && this.progress >= limit) || (direction === 'empty' && this.progress <= limit)) {
      ...
      return setProgressUI.call(this);
    }
  };
  setProgressUI = function() {
    var empty, full;
  ...
  EAProgressVertical = (function() {
    ...
    EAProgressVertical.prototype.startProgress = function() {
      ...
      return this.animateInterval = setInterval(animateBottle.bind(this), this.delay, this.type, limit);
    };
    ...
    EAProgressVertical.prototype.setProgress = function(progress, slow) {
      ...
      if (!slow) {
        ...
        clearInterval(this.animateInterval);
        this.animateInterval = setInterval(animateBottle.bind(this), this.delay, 'fill', progress, this);
      } else {
        clearInterval(this.animateInterval);
        this.animateInterval = setInterval(animateBottle.bind(this), this.delay, 'empty', progress, this);
      }
      return progress;
    };
